...
ui <- navbarPage(
  ...
  tabPanel("Historical Plots",
           ...
           selectInput("region_choice",
                       ...
                       choices = c("All", "West", "East", "Midest", "Southeast", "Final Four", "Championship", "South", "Southwest"),
                       selected = "All"),
...
server <- function(input, output, session) {
  ...
  output$Variable_Description <- renderPrint({
    if (input$stat_type == "Defensive and Opponent Stats"){
      ...
      print("PlayOff_Seed: Playoff Seed")
      print("Conf: Conference")
      print("Games_Played: Number of games played")
      print("Barthag: Power Rating")
      print("AdjDE: Adjusted Defensive Efficiency")
      print("`EFG%`: Effective Field Goal Percentage")
      print("DRB: Defensive Rebound Percentage")
      print("FTRD: Free Throw Rate Defense")
      print("`2P%D`: Two-Point Defense")
      print("`3P%D`: Three-Point Defense")
      print("`3PRD`: Three-Point Rate Defense")
      print("`Adj T.`: Adjusted Tempo")
      print("WAB: Wins Above Bubble")
    } else {
      print("Team: Team name")
      print("PlayOff_Seed: Playoff Seed")
      print("Conf: Conference")
      print("Games_Played: Number of games played")
      print("Barthag: Power Rating")
      print("AdjOE: Adjusted Offensive Efficiency")
      print("`EFGD%`: Effective Field Goal Percentage Allowed")
      print("ORB: Offensive Rebound Rate")
      print("FTR: Free Throw Rate (Free Throws Attempted per Field Goal Attempted)")
      print("`2P%`: Two-Point Field Goal Percentage")
      print("`3P%`: Three-Point Field Goal Percentage")
      print("`3PR`: Three-Point Attempt Rate (Three-Point Field Goal Attempts per Field Goal Attempts)")
      print("`Adj T.`: Adjusted Tempo")
      print("WAB: Wins Above Bubble")
    }
  })
  ...
  output$Team_Table <- renderTable({
    mm24TableFiltered()
  }, digits = 3, width = "100%", bordered = TRUE, striped = TRUE)

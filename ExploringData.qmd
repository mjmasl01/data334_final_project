...
ui <- navbarPage(
  ...
  tabPanel("Statistics",
           icon = icon("table"),
           titlePanel(tags$h1("2024 March Madness Tournament Results", style = "font-weight: bold; text-align: center; color: darkblue; font-size: 40px;")),
  ...
  tabPanel("Historical Plots",
           ...
           titlePanel(tags$h1("March Madness Tournament Results from 1985 to 2019", style = "font-weight: bold; text-align: center; color: darkblue; font-size: 40px;")),
           fluidRow(
           ...
           tags$p("For the vizual, select one of the playoff rounds 1-6, 5 being the final four, and 6 being the championship. Based off round selection, the regions in which the teams are from will update depending on who is still remaining in that particular round. Yes, the plot looks clustered, however, adjust the years in order to view a range of points better. Also, utilize the interactive features in the top-right corner of the plot, user can select 'Compare data on hover' which will display all games, with team names and results at same time.", style = "font-size: 14px; text-align: center; color: black;"),

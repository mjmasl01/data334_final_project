...
ui <- navbarPage(
  ...
  tabPanel("Statistics",
           ...
           tags$br(),
           tags$br(),
           titlePanel(tags$h1("2024Tournament Results", style = "font-weight: bold; text-align: center; color: darkblue; font-size: 40px;")), 
           tags$p("Author: Matt Maslow", style = "font-size: 18px;  text-align: center; color: darkblue;"),
           fluidRow(
             column(3, radioButtons("stat_type", 
                                    label = "Pick a Stat:",
                                    choices = c("Defensive and Opponent Stats", "Offensive Stats"),
                                    selected = "Offensive Stats")),
             column(3, selectizeInput("Team_choice", label = "Select a team or multiple:",
  ...
  tabPanel("Historical Plots",
           ...
           tags$p("For the visualization, choose one of the playoff rounds from 1 to 6 (1 = first round, 2 = second round, 3 = Sweet 16, 4 = Elite 8, 5 = Final Four, and 6 = Championship). Depending on the selected round, the regions from which the teams hail will update to reflect the remaining teams in that particular round. While the plot may appear crowded, adjusting the years can provide a clearer view of the data range. Additionally, take advantage of the interactive features located in the top-right corner of the plot. Users can select 'Compare data on hover', which will simultaneously display all games, team names, and results.", style = "font-size: 14px; text-align: center; color: black;"),
